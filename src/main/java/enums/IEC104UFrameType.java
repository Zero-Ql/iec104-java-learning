...
public enum IEC104UFrameType {
    ...
    public static final Map<Integer, IEC104UFrameType> U_CONTROL_MAP = new HashMap<>();

    IEC104UFrameType(int value) {
        this.value = value;
    }

    static {
        for (IEC104UFrameType type : values())
